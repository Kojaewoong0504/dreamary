                    ...
                    <div className="glass-panel p-8 rounded-3xl backdrop-blur-xl border border-white/10 shadow-2xl">
                        <div className="text-center mb-8">
                            <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-white/60 mb-2">
                                {isSignUp ? (step === 'info' ? "Profile Info" : "Create Account") : "Welcome Back"}
                            </h1>
                        ...
                        <form onSubmit={isSignUp && step === 'credentials' ? handleNextStep : handleAuth} className="space-y-5">
                                    ...
                                    >
                                        <div className="relative group">
                                            ...
                                            <input
                                                ...
                                                disabled={isSocialSignup} // Disable if social signup
                                                className="w-full bg-white/5 border border-white/10 rounded-xl py-3.5 pl-11 pr-4 text-white placeholder:text-white/30 focus:outline-none focus:border-dream-cyan/50 focus:bg-white/10 transition-all disabled:opacity-50"
                                                required
                                            />
                                        </div>
                                        <div className="relative group">
                                ...
                                {isSignUp && step === 'info' && (
                                    ...
                                    >
                                        <div className="space-y-4">
                                            <div className="relative group">
                                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                                    <User className="text-white/40 group-focus-within:text-dream-cyan transition-colors" size={18} />
                                                </div>
                                                <input
                                                    type="text"
                                                    placeholder="닉네임"
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="flex-1 group relative overflow-hidden bg-gradient-to-r from-dream-purple to-dream-cyan text-white font-bold py-3.5 rounded-xl shadow-[0_0_20px_rgba(168,85,247,0.3)] hover:shadow-[0_0_30px_rgba(34,211,238,0.5)] transition-all disabled:opacity-70 disabled:cursor-not-allowed"
                                >
                        ...
                        <p className="mt-8 text-center text-xs text-white/40 space-x-4">
                            <button onClick={() => router.push('/find-id')} className="hover:text-white transition-colors">아이디 찾기</button>
                            <span>|</span>
                            <button onClick={() => router.push('/reset-password')} className="hover:text-white transition-colors">비밀번호 재설정</button>
                        </p>
